    ...
    <div class="items-mobile">
        @foreach ($quote->items as $item)
            <div class="item-card">
                ...
                @if ($item->description)<div class="item-card-desc">{{ $item->description }}</div>@endif
                <div class="item-card-rows">
                    ...
                    @if ((float) $item->discount_amount > 0)<span>الخصم:</span><strong>{{ number_format((float) $item->discount_amount, 2) }}</strong>@endif
