@php
    /** @var \App\Domain\Sales\Models\Invoice|null $invoice */
    $invoice ??= null;
    $isEdit = $invoice && $invoice->exists;
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="event_name" class="form-control"
                       value="{{ old('event_name', $invoice?->event_name) }}" required>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="date" name="event_start_date" class="form-control"
                       value="{{ old('event_start_date', $invoice?->event_start_date?->format('Y-m-d')) }}">
            </div>
            <div class="form-group">
                <label>تاريخ الانتهاء</label>
                <input type="date" name="event_end_date" class="form-control"
                       value="{{ old('event_end_date', $invoice?->event_end_date?->format('Y-m-d')) }}">
            </div>
            <div class="form-group">
                <label>الموقع</label>
                <input type="text" name="event_location" class="form-control"
                       value="{{ old('event_location', $invoice?->event_location) }}">
            </div>
            <div class="form-group">
                <label>نوع الفعالية</label>
                <input type="text" name="event_type" class="form-control"
                       value="{{ old('event_type', $invoice?->event_type) }}">
            </div>
        </div>
