        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" step="0.0001" name="area_per_unit" id="area_per_unit" class="form-control" value="{{ old('area_per_unit', 0) }}" min="0">
                    @error('area_per_unit')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="tiles_per_box" id="tiles_per_box" class="form-control" value="{{ old('tiles_per_box') }}" min="0">
                    @error('tiles_per_box')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.0001" name="tile_area" id="tile_area" class="form-control" value="{{ old('tile_area') }}" min="0">
                    @error('tile_area')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
