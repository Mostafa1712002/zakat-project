...
<div class="page-header">
    <div>
        ...
        <p>إنشاء دور جديد وتحديد صلاحياته</p>
    </div>
...
<form action="{{ route('settings.roles.store') }}" method="POST">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" required placeholder="مثال: accountant">
                ...
                <div class="permission-group">
                    ...
                    <div class="permission-group-body">
                        ...
                        <label class="checkbox-label permission-item">
                            <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" class="permission-checkbox" data-group="{{ $group }}" {{ in_array($permission->name, old('permissions', [])) ? 'checked' : '' }}>
    ...
    <div class="card" style="margin-top: 1.5rem;">
        <div class="card-body">
            <button type="submit" class="btn btn-primary btn-lg">حفظ الدور</button>
