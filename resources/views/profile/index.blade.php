    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('profile.update') }}" method="POST">
                ...
                <button type="submit" class="btn btn-primary" style="width: 100%; padding: 12px;  background: linear-gradient(180deg, #0891b2 0%, #0e7490 100%); border: none; border-radius: 8px; color: #fff; cursor: pointer; font-size: 16px;">
                    💾 حفظ التغييرات
                </button>
            </form>
        </div>
