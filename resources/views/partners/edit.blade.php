        ...
        <form action="{{ route('partners.update', $partner) }}" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="initial_investment" id="initial_investment" class="form-control" value="{{ old('initial_investment', $partner->initial_investment) }}" min="0">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" name="join_date" id="join_date" class="form-control" value="{{ old('join_date', $partner->join_date?->format('Y-m-d')) }}">
                    @error('join_date')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <textarea name="address" id="address" class="form-control" rows="2">{{ old('address', $partner->address) }}</textarea>
            </div>

            <div class="form-group">
                <label for="notes" class="form-label">ملاحظات</label>
                <textarea name="notes" id="notes" class="form-control" rows="3">{{ old('notes', $partner->notes) }}</textarea>
            </div>
