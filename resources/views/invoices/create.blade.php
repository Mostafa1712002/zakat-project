    ...
    <div class="card" style="margin-top: 1.5rem;">
        <div class="card-body">
            ...
            <table class="table" id="itemsTable">
                    ...
                    <tr class="item-row" data-index="0">
                        <td>
                            <select name="items[0][product_id]" class="form-control product-select" required>
                                ...
                                <option value="{{ $product->id }}" data-price="{{ $product->selling_price }}">{{ $product->name }} - {{ number_format($product->selling_price, 2) }} ج.م</option>
                                @endforeach
                            </select>
                        </td>
                ...
                <tfoot>
                    <tr>
                        <td colspan="6"><button type="button" class="btn btn-sm" id="addRowBtn">+ إضافة صنف</button></td>
                    </tr>
                </tfoot>
            </table>
